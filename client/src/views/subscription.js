        ...
        {this.props.theme.length > 0 &&
          <div>
            ...
            >
              <Grid container style={{ flexGrow: 1, margin: "0 auto", maxWidth: "50em" }} direction={'column'} justify={'flex-start'} alignItems={'flex-start'}>
                <Grid item style={{ marginBottom: 30 }}>
                  ...
                  <div style={{ marginTop: 16, color: this.props.theme[0].PostsTypographyTitle, letterSpacing: '-0.5px', fontSize: '21px', fontWeight: 100, fontFamily: "-apple-system,BlinkMacSystemFont,\"Segoe UI\",Helvetica,Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\"" }}>
                    You've taken your first step into the Information Security Incident Response community.
                            </div>
                </Grid>
                <Grid item>
              ...
              <Grid container style={{ flexGrow: 1, border: this.props.theme[0].PostsButtonBorder, borderRadius: this.props.theme[0].BorderRadius, background: this.props.theme[0].PostsButtonBackground, margin: "0 auto", maxWidth: "50em", padding: 20, marginTop: 20 }} direction={'row'} justify={'space-around'} alignItems={'center'} spacing={0}>
